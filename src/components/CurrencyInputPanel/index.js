...
const CurrencySelect = styled.button`
  ...
  height: 2rem;
  border: 1px solid ${({ selected, theme }) => (selected ? theme.royalBlue : theme.royalBlue)};
  border-radius: 2.5rem;
  ...
  :hover {
    border: 1px solid
      ${({ selected, theme }) => (selected ? transparentize(0.2, theme.royalBlue) : transparentize(0.2, theme.royalBlue))};
  }

  :focus {
    border: 1px solid ${({ theme }) => transparentize(0.2, theme.royalBlue)};
  }
